# Save this file on your ESP32 as /lib/micropyGPS.py
# A simple, lightweight NMEA sentence parser for MicroPython
# Original by Michael P. M. K. <https://github.com/inmcm/micropyGPS>
# Heavily modified for simplicity
...
class MicropyGPS:
    ...
    def update(self, sentence):
        try:
            ...
            # Check checksum (optional but good)
            try:
