# Save this file on your ESP32 as mpu6050.py

# MPU6050 simple MicroPython driver
# Based on the work by J.C. Waryn
...
class accel():
    ...
    def get_values(self):
        ...
        return values  # returned in range of Int16
        # -32768 to 32767
    ...
    def get_accl_y(self):
        raw_ints = self.get_raw_values()
        return self.bytes_toint(raw_ints[2], raw_ints[3])

    def get_accl_z(self):
        raw_ints = self.get_raw_values()
        return self.bytes_toint(raw_ints[4], raw_ints[5])

    def get_gyro_x(self):
        raw_ints = self.get_raw_values()
        return self.bytes_toint(raw_ints[8], raw_ints[9])

    def get_gyro_y(self):
        raw_ints = self.get_raw_values()
        return self.bytes_toint(raw_ints[10], raw_ints[11])

    def get_gyro_z(self):
        raw_ints = self.get_raw_values()
        return self.bytes_toint(raw_ints[12], raw_ints[13])
